...
import argparse
from PIL import Image  # for reading exif data
...
parser.add_argument("-M", "--model", help="Specify which camera model's files should be modified", required=False)
...
for filename in os.listdir(directory):
    ...
    if args.model is not None:
        ...
        exif_model = exif_data[272]
        if exif_model != args.model:
            continue
